...
import clockAudio from '../styles/audio/clock.mp3';
  ...
  render() {
    ...
    return (
      <div className="question-container">
        <audio src={ clockAudio } autoPlay loop></audio>
        <h3 data-testid="question-category">{category}</h3>
        <h4 data-testid="question-text">{this.decode(question)}</h4>
        {/* <h2>Categoria Trybe</h2>
        <h1>O que tem para comer ai?</h1> */}
        <div className="question-answers">
          {/* <button className="btn">Futras e Legumes</button>
          <button className="btn">Frango</button>
          <button className="btn">Pao com mortadela</button>
